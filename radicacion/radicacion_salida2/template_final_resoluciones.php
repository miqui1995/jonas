...
<head>
    ...
    <style type="text/css">
        ...
        p {     
            /*margin-top      : -20px; */
            margin-top      : 1px; /* Reemplazarlo al cambiar a template_resoluciones */
            margin-bottom:  : 1px;
        }
...
/* Desde aqui empiezo a editar la plantilla. */
    $resultado_js               = $_POST['resultado_js'];   // Contenido del documento
    ...
    switch ($codigo_entidad) {
        case 'AV1':
            ...
            /* Se deja margin-top:0 px porque es para la primera hoja de todas. */
            $cuerpo_radicado = "
            <div class='class' align='left' style='position:relative; top:70px!important; margin-top: 0px!important;'>
                <p>$resultado_js</p>
                *IMAGEN_FIRMA*";
            break;
        ...
        default:
            /* Encabezado del comunicado */
            $encabezado_comunicado = "<div align=left style='position: absolute;top: 5px; left: 26%; width:350px; text-align: center;'><h4>RADICADO *NUMERO_RADICADO_FINAL*</h4></div>
                ";
