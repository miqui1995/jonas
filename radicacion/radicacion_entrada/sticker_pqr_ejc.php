<?php 
/* Este archivo sirve para imprimir un sticker incluyendo codigo QR y codigo de barras, recibe todas las variables 
mediante GET y se invoca desde Orfeo enviando variables del aplicativo de PQR de Ejercito. 
 El QR se invoca desde require ('../../include/phpqrcode/qrlib.php'); */
...
if(isset($_GET['asunto'])){
    ...
    $asunto     = "<tr><td style='width: 250px;'><b>Documento recibido mediante módulo de PQR</b></td></tr>";
}
            ...
            <td colspan='2'>
                <center>
                    <div id="titulo_sticker" size="2">
                        <b>Radicado de Entrada - Ejercito Nacional - PQR</b>
                    </div> 
                </center>   
            </td>
            <td rowspan="5">
